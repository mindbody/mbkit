import React, { RefObject, HTMLAttributes, FC, forwardRef, RefAttributes } from 'react';
...
export const Heading: FC<HeadingProps> = forwardRef((props: HeadingProps, ref: RefObject<HTMLHeadingElement>) => {
