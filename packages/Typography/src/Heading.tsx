import React, { RefObject, HTMLAttributes, FC, forwardRef } from 'react';
...
export const Heading: FC<HeadingProps & HTMLAttributes<HTMLHeadingElement>> = forwardRef(
    (props: HeadingProps & HTMLAttributes<HTMLHeadingElement>, ref: RefObject<HTMLHeadingElement>) => {
