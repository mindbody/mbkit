import React, { forwardRef, FC, RefObject, HTMLAttributes } from 'react';
...
export const Text: FC<TextProps & HTMLAttributes<HTMLElement>> = forwardRef(
    (props: TextProps & HTMLAttributes<HTMLElement>, ref: RefObject<HTMLElement>) => {
