...
const BaseGlyph: React.FC<BaseGlyphProps> = (props: BaseGlyphProps) => {
    const { width = '16', height = '16', color, children, className = '', ...rest } = props;
...
export const GlyphAdd: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphCall: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphCamera: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphCaution: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphChat: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphChevronBack: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Chevron---Back-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path
                    id={`Mask-${id}`}
                    fill="#54575F"
...
export const GlyphChevronDown: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Chevron---Down-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path
                    id={`Mask-${id}`}
                    fill="#54575F"
...
export const GlyphChevronForward: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Chevron---Forward-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path
                    id={`Mask-${id}`}
                    fill="#54575F"
...
export const GlyphChevronUp: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphClear: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphClose: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphDownload: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphDropdown: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g
...
export const GlyphEdit: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphEmail: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphError: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphFavorite: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphFavoriteFilled: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Favorite---Filled-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path
                    id={`Mask-${id}`}
                    fill="#54575F"
...
export const GlyphInformation: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphLocation: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphLockUnlocked: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphLocalLocked: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphNext: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphPrevious: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphOther: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphPlay: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphPreviewHidden: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Preview-Hidden-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path
                    id={`Mask-${id}`}
                    fill="#54575F"
...
export const GlyphRefresh: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphRemove: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <>
                <defs>
...
export const GlyphSave: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphSearch: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphSettings: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphSliderIndicator: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Slider-Indicator-${id}`} fill="none" fillRule="evenodd" stroke="none" strokeWidth="1">
                <path id={`Mask-${id}`} fill="#54575F" d="M9 12L4 4h10z" transform="rotate(-90 9 8)" />
            </g>
        )}
    </BaseGlyph>
);
export const GlyphSortOrder: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphSortedDown: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <>
                <defs>
...
export const GlyphSortedUp: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <>
                <defs>
...
export const GlyphStart: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphSuccess: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphTrash: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
...
export const GlyphUnsorted: React.FC<GlyphProps> = (props: GlyphProps) => (
    <BaseGlyph {...props}>
        {({ id }) => (
            <g id={`Icons/Glyphs/Sort/Unsorted-${id}`} fill="#A0A5AB" fillRule="evenodd" stroke="none" strokeWidth="1">
