...
Yes! After you've installed this package as a dependency you can add this line "@import '~@mbkit/theme/dist/theme.scss';" in any of your scss files and it will allow you to consume the SCSS variables. Variable names follow the JSON structure just like the CSS variables. 
